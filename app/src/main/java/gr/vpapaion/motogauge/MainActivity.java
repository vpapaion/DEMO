...
public class MainActivity extends Activity implements SensorEventListener, LocationListener {
    ...
    @Override public void onSensorChanged(SensorEvent event) {
        ...
        // Android's rotation-vector sign is opposite to the rider's visual
        // left/right direction for a screen facing the rider. Apply the same
        // rider-relative convention in both portrait and landscape.
        lean=-lean;
